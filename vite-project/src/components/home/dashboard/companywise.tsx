...
const CompanyApexChart = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center flex-col rounded-xl py-2 px-4 md:py-4 md:px-2 shadow-lg shadow-black/30'>
        <h1 className='text-gray-800 md:text-xl mx-auto'>Company wise data of maximum transactions(crore)</h1>
