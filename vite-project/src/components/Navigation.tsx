...
export default function NavigationBar() {
    ...
    return (
        // <nav
        //     className="sticky top-0 z-[2147] block w-full max-w-full px-4 py-2 text-white bg-gray-900 rounded-none shadow-lg shadow-black/50 h-max  bg-opacity-90 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
        ...
        //     </div>
        // </nav>
        <nav className="bottom-0 w-full flex flex-row fixed z-[2132321]">
            <div className="w-full bg-slate-800 flex flex-row justify-evenly rounded-md py-2">
