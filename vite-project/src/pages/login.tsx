...
import { useNavigate } from 'react-router-dom'; // Correct import for redirection
import { Authenticate } from '../services/auth'; // Your login service function
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (emailRef.current && passwordRef.current) {
      ...
      try {
        // Call the Authenticate function manually here
      ...
      <div className='flex justify-center items-center min-h-screen'>
        ...
        <form className=' bg-cyan-300 p-8 flex justify-center items-center rounded-lg shadow-xl' onSubmit={(e) => handleSubmit(e)}>
